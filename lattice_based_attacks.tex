...
and using a similar lattice constructions as the one we will describe to solve the \textit{HNP}
and thus breaks the protocol \cite{cryptoeprint:2020:1151} (Raccoon Attack).
...
vulnerabilities can heavily compromise the security of the protocol.
